...
const showError = (message, container) => {
    ...
    errorElement.innerHTML = `<img src="icons/error.svg" alt="Error:" class="icon error-icon"> ${message}`;
...
const createMainContent = (extension, container) => {
    ...
    idLine.appendChild(createElement('img', { src: 'icons/id.svg', alt: '', className: 'icon' }));
    ...
    if (extension.updateUrl) {
        ...
        updateUrlLine.appendChild(createElement('img', { src: 'icons/update.svg', alt: '', className: 'icon' }));
    ...
    versionElement.appendChild(createElement('img', { src: 'icons/info.svg', alt: '', className: 'icon' }));
    ...
    statusElement.appendChild(createElement('img', { src: 'icons/status.svg', alt: '', className: 'icon' }));
    ...
    if (extension.homepageUrl && extension.homepageUrl !== webStoreLink) {
        ...
        homepageElement.innerHTML = `<img src="icons/link.svg" alt="" class="icon"> Homepage: `;
    ...
    if (webStoreLink) {
        ...
        storeElement.innerHTML = `<img src="icons/store.svg" alt="" class="icon"> Store: `;
    ...
    if (extension.optionsUrl) {
        ...
        optionsElement.innerHTML = `<img src="icons/settings.svg" alt="" class="icon"> Options: `;
